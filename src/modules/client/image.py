...
in the environment or by setting simulate_cmdpath in DebugValues.""")
    ...
    def get_last_modified(self, string=False):
        ...
        if self.version >= 5:
            ...
            # catalog object returned by __get_catalog may be an
        ...
        try:
            ...
            if self.version >= 5:
                ...
                if all(
                    ...
                    # At least one catalog is an in-memory
    ...
    def update_pkg_installed_state(self, pkg_pairs, progtrack, origin):
        ...
        # Every package whose catalog entry is touched here, for the
    ...
    def get_solver_catalog(self):
        """Return the catalog object the dependency solver should
    ...
    def get_list_catalog(self, name):
        """Return the catalog object package listing operations
        should use for the given image catalog name: a ListCatalog
    ...
    def __get_catalog(self, name):
        ...
        if self.version >= 5:
            if self.__alt_pkg_pub_map:
                ...
                # materialise a mutable in-memory catalog from
    ...
    def get_action_cache(self, progtrack=None):
        ...
        # in a temporary directory instead.  When a database already
        # exists this is still proportional to the number of changed
        # packages rather than the full rebuild formerly needed here.
        cache.close()
